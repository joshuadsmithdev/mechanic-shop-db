# mechanic_shop_backend/app/blueprints/customers/routes.py
from flask import Blueprint, request, jsonify

# ⬅️ use relative imports to the app package
...
def create_customer():
    ...
    # Validate & load via marshmallow
    customer = customer_schema.load(data, session=db.session)

    # Optional password setter if present
...
# PUT /api/customers/<id> (partial allowed)
